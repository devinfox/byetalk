                        ...
                        <div className={styles.bdlPaymentGrid}>
                          ...
                          <div className={styles.bdlPaymentRight}>
                            <div className={styles.bdlCheckItem}>
                              ...
                              <span>OVERNIGHT CHECK <span className={styles.bdlCheckNote}>($30 fee applies; cannot overnight to a PO Box. Also,<br/><span style={{paddingLeft: '85px'}}>invoice must be attached)</span></span></span>
                            </div>
                            <div className={styles.bdlCheckItem}>
